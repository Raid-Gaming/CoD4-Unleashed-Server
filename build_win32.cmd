...
echo Linking...
gcc -g -Wl,--nxcompat,--image-base,0x8040000 -Tlinkerscript_win32.ld -o bin/cod4x_win32 bin/*.o src/win32/win_cod4.res -Llib/ -ltomcrypt_win32 -ltommath_win32 -lm -lws2_32 -lwsock32 -lgdi32 -mwindows -lwinmm -static-libgcc
echo Cleaning up...
cd bin
del *.o
...
pexports cod4x_win32.exe > cod4x_win32.def
rename cod4x_win32.exe _____________________________________________cod4x_win32.exe
dlltool -D _____________________________________________cod4x_win32.exe -d cod4x_win32.def -l ..\plugins\libcom_plugin.a
rename _____________________________________________cod4x_win32.exe cod4x_win32.exe
