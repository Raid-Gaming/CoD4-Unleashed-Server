...
char* asyncHttpRequest(char* host, int port, char* path, enum HttpMethod method,
                       char* contentType, char* data, int getResponse) {
  return "";
}
...
void GScr_HttpGet() {
  ...
  Scr_AddString(asyncHttpRequest(host, port, path, GET, "application/json", "",
...
void GScr_HttpPost() {
  ...
  if (params < 4 || params > 6) {
    Scr_Error("Usage: httpPost(<host>, <port>, <path>, <data>, <optional: "
              "contentType>, <optional: receive>)\n");
    return;
  }
  ...
  Scr_AddString(
      asyncHttpRequest(host, port, path, POST,
                       params > 4 ? Scr_GetString(4) : "application/json", data,
...
void GScr_HttpPut() {
  ...
  if (params < 4 || params > 6) {
    Scr_Error("Usage: httpPut(<host>, <port>, <path>, <data>, <optional: "
              "contentType>, <optional: receive>)\n");
    return;
  }
  ...
  Scr_AddString(asyncHttpRequest(
      host, port, path, PUT, params > 4 ? Scr_GetString(4) : "application/json",
      data, params == 6 ? Scr_GetInt(5) : 1));
}
...
void GScr_HttpPatch() {
  ...
  if (params < 4 || params > 6) {
    Scr_Error("Usage: httpPatch(<host>, <port>, <path>, <data>, <optional: "
              "contentType>, <optional: receive>)\n");
    return;
  }
  ...
  Scr_AddString(
      asyncHttpRequest(host, port, path, PATCH,
                       params > 4 ? Scr_GetString(4) : "application/json", data,
                       params == 6 ? Scr_GetInt(5) : 1));
}
...
void GScr_HttpDelete() {
  ...
  if (params < 3 || params > 6) {
    Scr_Error("Usage: httpDelete(<host>, <port>, <path>, <optional: data>, "
              "<optional: contentType>, <optional: receive>)\n");
    return;
  }
  ...
  Scr_AddString(
      asyncHttpRequest(host, port, path, DELETE,
                       params > 4 ? Scr_GetString(4) : "application/json", data,
                       params == 6 ? Scr_GetInt(5) : 1));
}
...
void GScr_HttpRequest() {
  ...
  if (params < 4 || params > 7) {
    Scr_Error("Usage: httpRequest(<method>, <host>, <port>, <path>, <optional: "
              "data>, <optional: contentType>, <optional: receive>)\n");
    return;
  }
  ...
  Scr_AddString(
      asyncHttpRequest(host, port, path, strToHttpMethod(Scr_GetString(0)),
                       params > 5 ? Scr_GetString(5) : "application/json", data,
