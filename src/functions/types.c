...
void GScr_isFunction() { isCheck(Scr_GetType(0) == 9, "isFunction"); }

void GScr_isVector() { isCheck(Scr_GetType(0) == 4, "isVector"); }

void GScr_isLocalizedString() {
  isCheck(Scr_GetType(0) == 3, "isLocalizedString");
}

void GScr_isInt() { isCheck(Scr_GetType(0) == 6, "isInt"); }

void GScr_isFloat() { isCheck(Scr_GetType(0) == 5, "isFloat"); }

// Objects are fucking weird
void GScr_isObject() { isCheck(Scr_GetType(0) == 1, "isObject"); }
