...
const char* Sys_GetCommandline(void) { return cmdline; }
...
*/
void Sys_Init() {
  Cvar_RegisterString("arch", OS_STRING "-" ARCH_STRING, CVAR_ROM,
                      "System platform");
  Cvar_RegisterString("username", Sys_GetUsername(), CVAR_ROM,
                      "Current username");
}
...
=================
*/
const char* Sys_ExeFile(void) { return exeFilename; }
...
=================
*/
const char* Sys_BinaryPath(void) { return binaryPath; }
...
=================
*/
const char* Sys_DefaultAppPath(void) { return Sys_BinaryPath(); }
...
void Sys_Restart(const char* reason) {
  ...
  Com_sprintf(commandline, sizeof(commandline), "%s %s", Sys_ExeFile(),
              Sys_GetCommandline());
  ...
  Com_Printf(
      "If you can see this, call 911! Something went terribly wrong...\n");
  exit(87);
}
