...
const char* __cdecl PbAuthClient(const char* NETAdrString,
                                 qboolean cl_punkbuster, const char* pbguid);
void __cdecl PbPassConnectString(const char* NETAdrString,
                                 const char* connectstring);
void __cdecl PbSvAddEvent(int event_type, int clientnum, int sizeofstring,
                          char* string);
