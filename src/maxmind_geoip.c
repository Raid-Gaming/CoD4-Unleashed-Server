...
unsigned int _GeoIP_seek_record(unsigned long ipnum) {
  ...
  */
  ...
  Com_PrintError(
      "Traversing Database for ipnum = %lu - Perhaps database is corrupt?\n",
      ipnum);
  FS_FCloseFile(file);
  return 0;
}

const char GeoIP_country_code[255][3] = {
...
const char GeoIP_country_code3[255][4] = {
...
const char* GeoIP_utf8_country_name[255] = {
    "N/A",
    "Asia/Pacific Region",
    "Europe",
    "Andorra",
...
const char* GeoIP_country_name[255] = {
    "N/A",
    "Asia/Pacific Region",
    "Europe",
    "Andorra",
