...
cvar_t* Cvar_RegisterString(const char* var_name, const char* var_value,
                            unsigned short flags, const char* var_description);
cvar_t* Cvar_RegisterBool(const char* var_name, qboolean var_value,
                          unsigned short flags, const char* var_description);
cvar_t* Cvar_RegisterInt(const char* var_name, int var_value, int min_value,
                         int max_value, unsigned short flags,
                         const char* var_description);
cvar_t* Cvar_RegisterEnum(const char* var_name, const char** valnames,
                          int defaultval, unsigned short flags,
                          const char* var_description);
cvar_t* Cvar_RegisterFloat(const char* var_name, float var_value,
...
void Cvar_SetColor(cvar_t* cvar, float red, float green, float blue,
                   float alpha);
...
void Cvar_ForEach(void (*callback)(cvar_t const*, void* passedhere),
                  void* passback);
...
void __cdecl Cvar_ForEach(void (*callback)(cvar_t const*, void* passedhere),
void* passback); char* __cdecl Cvar_DisplayableValue(cvar_t const*); char*
__cdecl Cvar_GetVariantString(const char* name); cvar_t* __regparm1
Cvar_FindMalleableVar(const char* name); void Cvar_Init(void);
*/
