...
typedef struct {
  ...
  int frame; // Current numbered packet which is going to be sent next. Any
             // value in range of acknowledge and sequence
...
void ReliableMessageSetup(netreliablemsg_t* chan, int netsrc, int qport,
                          netadr_t* remote);
