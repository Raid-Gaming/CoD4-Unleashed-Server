...
void __cdecl _isdead_dbg() { __asm__("int $3"); }

void __cdecl _isdead() {}

void* __cdecl _memalign(int align, int numbytes) { /* This can cause crash */
...
==================
*/
void* dlopen(const char* dl, int mode) { return NULL; }

const char* dlerror() { return NULL; }

void dlclose(void* handle) {}

void* dlsym(void* handle, const char* proc) { return NULL; }
...
int ___xstat(int __ver, const char* __filename, struct lnx_stat* __stat_buf) {
  ...
  HANDLE hFile = CreateFile(
      (LPCTSTR)__filename, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING,
...
/*
        Windows _stat() function seems not to work. As this was only used to
   retrive the filesize we only pass this
*/
...
qboolean Sys_CoD4Linker() {
  ...
  //    Sys_CoD4LinkObject(LD__ZNSs4_Rep10_M_destroyERKSaIcE ,
  //    _ZNSs4_Rep10_M_destroyERKSaIcE ); Sys_CoD4LinkObject(LD_sem_trywait ,
  //    sem_trywait );
  ...
  //     Sys_CoD4LinkObject(LD__ZSt20__throw_out_of_rangePKc ,
  ...
  //     Sys_CoD4LinkObject(LD__ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_RS_
  ...
  //     Sys_CoD4LinkObject(LD__ZN9__gnu_cxx18__exchange_and_addEPVii ,
  ...
  //    Sys_CoD4LinkObject(LD__ZSt18_Rb_tree_incrementPSt18_Rb_tree_node_base ,
  ...
  //    Sys_CoD4LinkObject(LD__ZSt18_Rb_tree_decrementPSt18_Rb_tree_node_base ,
