...
#define MAX_PLUGINS                                                            \
  25 // Maximum number of loaded plugins, hardcoded for better performance
...
#define PLUGIN_MAX_EXPORTS                                                     \
  50 // Maximum count of exported functions, each takes 32B of mem = 1kB per
     // plugin
...
void PHandler_CmdExecute_f(
    void); // fake server command for use in plugin commands
