...
void Sys_PlatformInit(void) {
  ...
  received_mem =
      mmap(allocptr - ((int)allocptr % pagesize),
           0xa60 + 0x4 + 0x1bf1a4 + 0x3c + 0x36898 + pagesize,
           PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_FIXED | MAP_ANON, 0, 0);
  ...
  received_mem =
      mmap(allocptr - ((int)allocptr % pagesize),
           0x9454 + 0x2c + 0xc182240 + pagesize, PROT_READ | PROT_WRITE,
